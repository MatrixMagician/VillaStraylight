// skew.go is THE single implementation of the embedding-skew comparison:
...
//
// Typed-Unknown discipline (the blockOnNewerStore "not recorded ⇒ no
...
// the configured cfgModel/cfgDim. Empty st.EmbeddingModel ⇒ SkewUnknown
