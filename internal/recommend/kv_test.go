...
func TestKVCacheBytesSaturatesOnOverflow(t *testing.T) {
	m := catalog.Model{NLayers: 48, NKVHeads: 8, HeadDim: 128, KVBytesPerElem: 2}
...
func TestKVCacheUsesKVHeads(t *testing.T) {
	gqa := catalog.Model{NLayers: 1, NKVHeads: 8, HeadDim: 128, KVBytesPerElem: 2}
	wrong := catalog.Model{NLayers: 1, NKVHeads: 32, HeadDim: 128, KVBytesPerElem: 2}
