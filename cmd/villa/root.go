...
func newRoot() *cobra.Command {
	...
	root.AddCommand(newDetect(), newRecommend(), newPreflight(), newModel(), newInference(), newInstall(),
		newUp(), newDown(), newRestart(), newLogs(), newConfig(), newStatus(), newDoctor(), newVerify(), newRecall(), newDashboard(), newWebsafe(), newBackend(), newSpeculation(), newToolsMode(), newCodingMode(), newCode(), newBench(), newBackup(), newRestore(), newUninstall(), newUpdate(), newWorkspace(), newSandboxBridge(), newWork(), newTask())
