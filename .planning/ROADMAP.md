...
- [x] 31-02-PLAN.md — `recommend` web-search reservation-before-fit (schema 3→4, one golden re-freeze) + `config` websafe fields/bearer/host-path (omit-when-off, byte-identical-off) (GROUND-03, GROUND-01, GROUND-02)
