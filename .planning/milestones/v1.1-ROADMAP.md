...
- [x] **Phase 11: Address v1.1 tech debt** — `rocm_readiness` detect probes + doc reconciliation (post-milestone tech-debt cleanup; 2 plans, 1 wave) (completed 2026-06-06)
...
- [x] 11-02-PLAN.md — tech-debt: add `requirements-completed` frontmatter to 6 SUMMARYs (DET-04/BSET-01..03/BENCH-02/REC-05, evidence-checked) + fix stale 06-REVIEW prose Status line + human-verify checkpoint on the REQUIREMENTS.md ROCM-02 note (no blind edit)
